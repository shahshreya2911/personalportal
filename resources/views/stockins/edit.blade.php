...
@section('page-title', 'Edit StockIn')
@section('page-heading', 'Edit StockIn')
...
{!! Form::open(['route' => 'stockin.storeedit', 'files' => true, 'id' => 'stockin-form' ,'method' =>'POST']) !!}
        ...
        <div class="card-body">
            <div class="row">
              <!--   <div class="col-md-3">
                ...
                <div class="col-md-12">
                    @include('stockins.partials.editdetails', ['edit' => false])
                </div>
            </div>
        </div>
    </div>
...
{!! JsValidator::formRequest('Vanguard\Http\Requests\Stockin\StockineditRequest', '#stockin-form') !!}
  <script>
