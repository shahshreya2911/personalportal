...
@section('page-title', 'Add StockIn')
@section('page-heading', 'Add StockIn')

@section('breadcrumbs')
    <li class="breadcrumb-item">
        <a href="{{ route('stockin') }}">StockIn</a>
    </li>
...
{!! Form::open(['route' => 'stockin.store', 'files' => true, 'id' => 'stockin-form' ,'method' =>'POST', 'enctype'=>'multipart/form-data' ]) !!}
        ...
        <div class="card-body">
            <div class="row">
               <!--  <div class="col-md-1">
                ...
                <div class="col-md-12">
                    @include('stockins.partials.details', ['edit' => false])
                </div>
            </div>
        </div>
    </div>
...
{!! JsValidator::formRequest('Vanguard\Http\Requests\Stockin\StockinRequest', '#stockin-form') !!}
  <script>
  function getval(sel)
{
    //alert(sel.value);
