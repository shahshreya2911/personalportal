...
{!! Form::open(['route' => 'job.storeedit', 'files' => true, 'id' => 'job-form' ,'method' =>'POST']) !!}
        ...
        <div class="card-body">
            <div class="row">
              <!--   <div class="col-md-3">
                ...
                <div class="col-md-12">
                    @include('jobs.partials.editdetails', ['edit' => false])
                </div>
            </div>
        </div>
    </div>
...
{!! JsValidator::formRequest('Vanguard\Http\Requests\Job\JobeditRequest', '#job-form') !!}
  <script>
