...
{!! Form::open(['route' => 'job.store', 'files' => true, 'id' => 'job-form' ,'method' =>'POST', 'enctype'=>'multipart/form-data' ]) !!}
        ...
        <div class="card-body">
            <div class="row">
               <!--  <div class="col-md-1">
                ...
                <div class="col-md-12">
                    @include('jobs.partials.details', ['edit' => false])
                </div>
            </div>
        </div>
    </div>
...
{!! JsValidator::formRequest('Vanguard\Http\Requests\Job\JobRequest', '#job-form') !!}
  <script>
  function getval(sel)
{
    //alert(sel.value);
