...
function appendRow()
{
   var d = document.getElementById('div');
   	 ...
   	 x++;
     d.innerHTML += "<div><input type='text' class='input' id='tst"+ x +"' name='answer' ><input type='button' id='btSubmit"+ x +"' class='btn' value='Submit' onclick='getTextValue()' /> <input type='button' class='remove_this btn' value='Remove Button' id='removeButton"+ x +"' /></div>";   
